...
- 2026-03-27: fix: close export window dropdown when clicking inside window but outside dropdown (50.9k loc)
- 2026-03-27: fix: paulstretch render button — no auto-render on mode select, lowercase label, right of value (50.9k loc)
- 2026-03-27: refactor: remove dead plugin editor overlay (PluginEditorWindow) — never used since plugins show native VST3 windows (50.7k loc)
- 2026-03-27: design: warp mode selector — centered text + hover state (50.8k loc)
- 2026-03-27: design: warp mode selector text now uses proper case matching other dropdowns (50.8k loc)
- 2026-03-27: design: remove check dots from warp mode dropdown (50.8k loc)
- 2026-03-27: design: palette bg now matches browser/context menu bg_base color (50.8k loc)
- 2026-03-27: design: context menu bg now matches browser bg_base color (50.8k loc)
- 2026-03-27: fix: remove checked dots from Snap to Grid and Snap to Vertical Grid in context menu (51.1k loc)
- 2026-03-27: fix: right-click on transport bar, command palette, and plugin editor no longer shows context menu (51.1k loc)
- 2026-03-27: fix: right-click on empty space in right window, settings window, and export window no longer shows context menu (51.1k loc)
- 2026-03-27: fix: right-click on empty space or tab labels in browser/layers panel no longer shows context menu (51.1k loc)
- 2026-03-27: docs: comprehensive algorithm documentation for warp/complex crate — phase vocoder, IPL, transient detection, signal flow diagrams, references (51.1k loc)
- 2026-03-27: design: warp button centered text + hover state matching reverse button (50.8k loc)
- 2026-03-27: design: remove WARP label, rename OFF/ON button to "Warp" (50.8k loc)
- 2026-03-27: feat: Complex warp mode — pure Rust phase vocoder with identity phase locking + transient detection for pitch-preserving time stretch (50.8k loc)
- 2026-03-27: design: settings buttons now have hover states + 24px height matching reverse button (50.6k loc)
- 2026-03-27: feat: blinking cursor in command palette search bar, matching browser search bar (50.6k loc)
- 2026-03-27: refactor: extract button component (push_instance/push_text) used in settings_window (50.5k loc)
- 2026-03-27: design: instruments/effects browser rows now use bg_base matching layers/samples background (50.6k loc)
- 2026-03-27: design: search bar taller (36px) with 6px border radius + rounded focus ring (50.6k loc)
- 2026-03-27: fix: remove circle indicator from settings dropdown buttons (50.6k loc)
- 2026-03-27: feat: "Add Effect" button now auto-focuses browser search bar (50.6k loc)
- 2026-03-27: fix: theme dropdown now closes when clicking outside it (50.6k loc)
- 2026-03-27: fix: layer rows now use bg_base to match browser background (50.6k loc)
- 2026-03-27: feat: add "Open" to canvas right-click context menu for MIDI clips with instruments (50.6k loc)
- 2026-03-27: refactor: rename "Default" theme preset to "Dark" (50.6k loc)
- 2026-03-27: feat: reverse button — centered text + hover effect like Add Effect (50.6k loc)
- 2026-03-27: feat: show success toast when project is saved (50.6k loc)
- 2026-03-27: refactor: remove Ableton preset, keep only Default and Light themes (50.6k loc)
- 2026-03-27: fix: settings and export window backgrounds now use bg_base to match browser (50.6k loc)
- 2026-03-27: refactor: remove 9 unused RuntimeTheme color fields (50.6k loc)
- 2026-03-27: fix: unify browser header, search bar, and transport to use bg_base for consistent dark theme (49.8k loc)
- 2026-03-27: fix: brightness slider now goes much darker — increased range (0.15→0.25) and lowered floor (0.05→0.01) (49.8k loc)
- 2026-03-27: fix: clip layer text to panel bounds so names don't overflow right border (49.8k loc)
- 2026-03-27: fix: browser sidebar and content panel now use the same background color (49.8k loc)
- 2026-03-27: feat: Paul Stretch warp mode — spectral time-stretching algorithm with configurable stretch factor, offline pre-processing (49.8k loc)
- 2026-03-27: feat: blinking cursor in browser search bar — 500ms on/off cycle, resets on keystroke (49.7k loc)
- 2026-03-27: feat: MIDI clips get random color from palette when created, matching waveform behavior (49.3k loc)
- 2026-03-27: fix: reset selection after slice (cmd+e) splits audio clip (49.3k loc)
- 2026-03-27: feat: instrument text label on MIDI clips — show plugin name like audio clip filenames, replacing pill badge (49.3k loc)
- 2026-03-27: feat: disconnect session command in command palette — manually leave realtime sessions (49.2k loc)
- 2026-03-27: fix: groups now rescale with BPM changes — stay on correct bar like audio/MIDI clips (49.2k loc)
- 2026-03-27: fix: browser search bar text invisible while editing — clip_top was clamping header text below content area (49.1k loc)
- 2026-03-27: tweak: decrease default auto fade in/out for audio samples from 10px to 6px (49.1k loc)
- 2026-03-27: feat: reconnection full sync — persistent "Reconnecting" toast, clean-slate state reset + ops replay on reconnect, "Connected" and "State synced" toasts (49.1k loc)
- 2026-03-27: refactor: loop region labels — remove pill badge + dashed top border, use plain text labels like audio samples with "Loop", "Loop 2" numbering (48.8k loc)
...
- 2026-03-27: fix: search bar text not visible while typing — missing text_dirty flag on input (46.0k loc)
- 2026-03-27: fix: undo paste/duplicate group now correctly removes pasted member entities (46.0k loc)
- 2026-03-27: fix: remove 18px top gap before sidebar items (Layers/Samples/Instruments/Effects) in browser panel (45.9k loc)
- 2026-03-27: fix: group duplicate/copy-paste now shifts member positions to match the new group position (45.9k loc)
- 2026-03-27: fix: remove extra indent from main layer entities — depth was +1 causing 16px excess left padding (45.6k loc)
- 2026-03-27: fix: remove category dot from Main layer entry in browser (45.6k loc)
- 2026-03-27: fix: duplicate/copy-paste group now deep-clones all member entities (waveforms, midi clips, instruments, etc.) instead of sharing refs (45.8k loc)
- 2026-03-27: fix: clicking Main in layers browser now highlights it as selected (45.6k loc)
- 2026-03-27: feat: layers indented under Main in browser; empty state "Nothing here yet" when no layers (45.6k loc)
- 2026-03-26: feat: create group from right-click context menu; undo group restores original selection (45.5k loc)
- 2026-03-26: fix: master right window no longer closes on mouse up after clicking it in the layers browser (45.4k loc)
- 2026-03-26: fix: implement top overlay layer — context menu geometry and text render in a separate pass after the main text renderer so the transport panel no longer bleeds through (45.4k loc)
...
- 2026-03-25: fix: layers panel — instrument and sample rows now have consistent left padding; MIDI properly indented under instrument (42.7k loc)
- fix: dropped instrument is instantly playable by keyboard — no longer auto-opens MIDI editor which blocked keyboard input (42.7k loc)
- feat: loop region created with Cmd+L now matches selected waveform/group width (42.7k loc)
- feat: recordings now named "Recording 1", "Recording 2", etc. like groups (42.7k loc)
- fix: MIDI clips no longer duplicated in layers panel when instrument and its clip are both group members (42.7k loc)
- feat: shift+click multi-selection on canvas and layers panel (42.6k loc)
- fix: computer MIDI keyboard enabled by default on app start (42.6k loc)
- fix: instrument inside group shows MIDI clips as sub-children in layers panel; dragging MIDI clip updates group bounds in real-time (42.5k loc)
- fix: group bounds recalculate to include instrument's child MIDI clips when instrument added to group (42.4k loc)
- fix: spacebar playback starts from group position when group is selected, same as audio clips (42.4k loc)
- feat: instrument selected state in layers panel — clicking highlights instrument, auto-arms computer keyboard for playback, switching instruments updates selection (42.4k loc)
- fix: allow grouping a single item (minimum changed from 2 to 1) (42.4k loc)
...
- test: verify copy/paste/duplicate preserves effect chain sharing — added 3 API-level tests confirming copies share the same effect_chain_id (41.9k loc)
- 2026-03-24: fix: takes system — recording into child takes resolves to parent, storage roundtrip preserves take_group, deletion cleans up take refs, click-to-switch active take, T key toggles expand/collapse, collapsed takes hidden on canvas, layers window shows takes as children (41.9k loc)
- refactor: remove PluginBlock feature entirely — standalone VST blocks on canvas, all related structs, ops, rendering, tests, and serialization deleted (41.6k loc)
